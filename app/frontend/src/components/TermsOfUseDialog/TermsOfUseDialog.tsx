                    ...
                    <DialogBody className={styles.dialogContent} >
                        ...
                        <DialogContent>
                            <ul>
                                ...
                                <li><strong>Überprüfung der Ergebnisse</strong> Die generierten Informationen bzw. Ergebnisse müssen stets auf inhaltliche Richtigkeit, Angemessenheit und Aktualität überprüft und bei Bedarf angepasst werden. Es kann vorkommen, dass aufgrund einer älteren Datenbasis, MUCGPT veraltete Ergebnisse liefert. Für die inhaltliche Richtigkeit ist immer der MUCGPT-Nutzende verantwortlich.</li>
                                <li><strong>Weiterverwendung der Ergebnisse:</strong> Die Verantwortung für die Weiterverwendung der Ergebnisse trägt die/der MUCGPT Nutzer*in. Die Ergebnisse müssen als solche sowohl für intern, als auch für extern gekennzeichnet (z.B.: „Quelle: MUCGPT“) werden. Siehe Details und weitere Zitierstile hierzu in den <Link inline href="/#faq">FAQs</Link>.</li>
                                ...
                                <li><strong>Ansprechpartner*innen:</strong> Bei Fragen und Feedback, sowie zum Melden von unangemessenen Ergebnissen von MUCGPT bitte an <Link inline href="mailto:itm.kicc@muenchen.de?subject=MUCGPT"> itm.kicc@muenchen.de
                                </Link> wenden.  Technische Fehler bitte an den <Link inline href="https://wilma.muenchen.de/pages/it-nutzung-support/apps/content/it-servicedesk-neu"> zuständigen Servicedesk</Link> melden</li>
