                        ...
                        <DialogContent>
                            <ul>
                                ...
                                <li><strong>Weiterverwendung der Ergebnisse:</strong> Die Verantwortung für die Weiterverwendung der Ergebnisse trägt die/der MUCGPT Nutzer*in. Bei unveränderter bzw. nur geringfügig veränderter Nutzung müssen diese als solche gekennzeichnet werden.
                                    Insbesondere, wenn die Inhalte für die externe Kommunikation verwendet werden. Siehe Details hierzu in den <a>FAQs</a>.</li>
                                ...
                                <li><strong>FAQs:</strong> Weitere Fragen und Antworten (u.a. zu Ziel und Einsatzzwecke von MUCGPT sowie zur Weiterverwendung der Eingaben und Ergebnisse) geben die <a>FAQs</a>.</li>
                                <li><strong>Best-Practice Dokumentation/Wissensmanagement:</strong> Erfolgreiche Anwendungsfälle von MUCGPT sollen dokumentiert werden, um wertvolles Wissen für zukünftige Projekte zu generieren. Tragen Sie diese Beispiele gerne <a>hier</a> ein.</li>
                            </ul>
                        </DialogContent>
                        <DialogActions>
                            <DialogTrigger disableButtonEnhancement>
