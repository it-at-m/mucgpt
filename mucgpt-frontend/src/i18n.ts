            ...
            DE: {
                translation: {
                    ...
                    app_sidebar: {
                        ...
                        new_chat_plain_description: "Starte einen freien Chat ohne Assistenten.",
                        new_chat_plain_cta: "Frei starten",
                        new_chat_assistant_title: "Mit diesem Assistenten starten",
                        new_chat_assistant_description: "Starte einen neuen Chat mit der Konfiguration dieses Assistenten.",
                        new_chat_assistant_cta: "Assistent starten",
            ...
            EN: {
                translation: {
                    ...
                    app_sidebar: {
                        ...
                        new_chat_plain_description: "Start an open chat without an assistant.",
                        new_chat_plain_cta: "Start freely",
                        new_chat_assistant_title: "Start with this assistant",
                        new_chat_assistant_description: "Start a new chat with this assistant's configuration.",
                        new_chat_assistant_cta: "Start assistant",
            ...
            BA: {
                translation: {
                    ...
                    app_sidebar: {
                        ...
                        new_chat_plain_description: "Start an freien Chat ohne Assistentn.",
                        new_chat_plain_cta: "Frei startn",
                        new_chat_assistant_title: "Mit dem Assistentn startn",
                        new_chat_assistant_description: "Start an neian Chat mit da Konfiguration von dem Assistentn.",
                        new_chat_assistant_cta: "Assistentn startn",
            ...
            FR: {
                translation: {
                    ...
                    app_sidebar: {
                        ...
                        new_chat_plain_description: "Démarrer un chat libre sans assistant.",
                        new_chat_plain_cta: "Démarrer librement",
                        new_chat_assistant_title: "Démarrer avec cet assistant",
                        new_chat_assistant_description: "Démarrer un nouveau chat avec la configuration de cet assistant.",
                        new_chat_assistant_cta: "Démarrer l'assistant",
            ...
            UK: {
                translation: {
                    ...
                    app_sidebar: {
                        ...
                        new_chat_plain_description: "Розпочніть вільний чат без асистента.",
                        new_chat_plain_cta: "Почати вільно",
                        new_chat_assistant_title: "Почати з цим асистентом",
                        new_chat_assistant_description: "Розпочніть новий чат з конфігурацією цього асистента.",
                        new_chat_assistant_cta: "Почати асистента",
