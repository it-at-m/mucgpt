            ...
            <div className={styles.faqRoot}>
                ...
                <Accordion multiple collapsible navigation="linear">
                    <AccordionItem value="1">
                        ...
                        <AccordionPanel>
                            <div className={styles.panel}>
                                ...
                                mit Hilfe eines neuronalen Netzes, um Antworten zu generieren, die natürlich und plausibel klingen. Diese Antworten sind nicht
                    ...
                    <AccordionItem value="2">
                        ...
                        <AccordionPanel>
                            <div className={styles.panel}>
                                MUCGPT basiert auf ChatGPT, ein Dienst von OpenAI und Microsoft. Der Unterschied zu ChatGPT liegt jedoch darin, dass Ihre
                    ...
                    <AccordionItem value="3">
                        ...
                        <AccordionPanel>
                            <div className={styles.panel}>
                                ...
                                der Nutzereingabe berechnet. Dahinter stecken Trainingsdaten, die unbekannt sind (wahrscheinlich sind das zum großen Teile Texte
                                ...
                                <p>
                                    MUCGPT generiert Wort für Wort aus den Eingaben. Da dahinter ein großes Sprachmodell ist, was auf einem Server mit vielen
                    ...
                    <AccordionItem value="4">
                        ...
                        <AccordionPanel>
                            <div className={styles.panel}>
                                MUCGPT darf von allen städtischen Mitarbeitern*innen inkl. externer Dienstleister*innen (alle die einen muenchen.de-Account
                    ...
                    <AccordionItem value="9">
                        ...
                        <AccordionPanel>
                            <div className={styles.panel}>
                                ...
                                Weiterverwendung der Ergebnisse trägt die/der MUCGPT Nutzer*in.
                                <p>
                    ...
                    <AccordionItem value="11">
                        ...
                        <AccordionPanel>
                            <div className={styles.panel}>
                                ...
                                E-Mailadressen etc.) eingegeben werden. Weiterhin dürfen keine Zahlungsdaten (IBAN, BIC, Zahlungsempfänger, Vertragspartner
