...
const createFluentThemeOverrides = (tokens: AppThemeTokens): Partial<Theme> => ({
    ...
    colorNeutralBackground1Pressed: tokens.surfaceRaised,
    ...
    colorNeutralBackground2Pressed: tokens.surfaceSubtle,
    colorNeutralBackground2Selected: tokens.surfaceSubtle,
    colorNeutralBackground3: tokens.surfaceSubtle,
    colorNeutralBackground3Hover: tokens.surfaceSubtleHover,
    colorNeutralBackground3Pressed: tokens.surfaceSubtleHover,
    colorNeutralBackground3Selected: tokens.surfaceSubtleHover,
    colorSubtleBackground: "transparent",
    colorSubtleBackgroundHover: tokens.surfaceSubtle,
    colorSubtleBackgroundPressed: tokens.surfaceSubtleHover,
    colorSubtleBackgroundSelected: tokens.surfaceSubtle,
    colorTransparentBackgroundHover: tokens.surfaceSubtle,
    colorTransparentBackgroundPressed: tokens.surfaceSubtleHover,
    colorNeutralForeground2BrandHover: tokens.linkForeground,
    colorNeutralForeground2BrandPressed: tokens.linkForeground,
    colorNeutralForeground2BrandSelected: tokens.linkForeground,
    colorNeutralBackgroundDisabled: tokens.disabledBackground,
    colorNeutralBackgroundDisabled2: tokens.disabledBackground,
    colorNeutralCardBackground: tokens.surfaceSubtle,
    colorNeutralCardBackgroundHover: tokens.surfaceSubtleHover,
    colorNeutralCardBackgroundPressed: tokens.surfaceSubtleHover,
    colorNeutralCardBackgroundSelected: tokens.surfaceSubtleHover,
    ...
    colorBrandForegroundLink: tokens.linkForeground,
    colorBrandForegroundLinkHover: tokens.linkForegroundHover,
    colorBrandForegroundLinkPressed: tokens.linkForegroundHover,
    colorBrandForegroundLinkSelected: tokens.linkForegroundHover,
