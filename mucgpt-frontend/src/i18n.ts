                ...
                translation: {
                    ...
                    components: {
                        ...
                        contextmanagerdialog: {
                            ...
                            description: "Wähle Dateien aus, die in deiner nächsten Frage verwendet werden sollen.",
                            uploading: "Wird hochgeladen...",
                            upload_section_title: "Dokumente hochladen",
                            upload_description: "Lade neue Dokumente hoch oder verwende bereits geparste Dokumente aus deinem lokalen Speicher.",
                            select_label: "Dateien auswählen",
                            select_hint: "Mehrere Dateien sind möglich.",
                            close: "Schließen",
                            saved_label: "Bereits hochgeladene Dokumente",
                            saved_count: "Anzahl: ",
                            no_saved: "Noch keine gespeicherten Dokumente.",
                            use: "Verwenden",
                            added: "Hinzugefügt",
                            remove_saved: "Gespeichertes Dokument entfernen",
                            parsed_at: "Geparsed",
                ...
                translation: {
                    ...
                    components: {
                        ...
                        contextmanagerdialog: {
                            ...
                            description: "Select files to include with your next question.",
                            uploading: "Uploading...",
                            upload_section_title: "Upload documents",
                            upload_description: "Upload new documents or reuse previously parsed documents from your local storage.",
                            select_label: "Choose files",
                            select_hint: "You can select multiple files.",
                            close: "Close",
                            saved_label: "Already uploaded documents",
                            saved_count: "Count: ",
                            no_saved: "No saved documents yet.",
                            use: "Use",
                            added: "Added",
                            remove_saved: "Remove saved document",
                            parsed_at: "Parsed",
            ...
            BA: {
                translation: {
                    ...
                    components: {
                        ...
                        contextmanagerdialog: {
                            title: "Kontextmanager",
                            description: "Wäh de Dateien aus, de bei da nächsten Frog dabei sei soin.",
                            uploading: "Wird obagloodn...",
                            upload_section_title: "Dokumente obalodn",
                            upload_description: "Lad neue Dokumente aufe oder verwende scho geparste Dokumente ausm lokalen Speicher.",
                            select_label: "Dateien aussuachn",
                            select_hint: "Mehrere Dateien san möglich.",
                            close: "Zumacha",
                            saved_label: "Scho obaglodne Dokumente",
                            saved_count: "Anzahl: ",
                            no_saved: "No koane gspeicherten Dokumente.",
                            use: "Verwenden",
                            added: "Dazua",
                            remove_saved: "Gspeicherts Dokument entfernen",
                            parsed_at: "Geparsed",
                ...
                translation: {
                    ...
                    components: {
                        ...
                        contextmanagerdialog: {
                            ...
                            description: "Sélectionnez les fichiers à utiliser avec votre prochaine question.",
                            uploading: "Téléversement...",
                            upload_section_title: "Téléverser des documents",
                            upload_description: "Téléversez de nouveaux documents ou réutilisez des documents déjà analysés depuis votre stockage local.",
                            select_label: "Choisir des fichiers",
                            select_hint: "Plusieurs fichiers peuvent être sélectionnés.",
                            close: "Fermer",
                            saved_label: "Documents déjà téléversés",
                            saved_count: "Nombre : ",
                            no_saved: "Aucun document enregistré pour l'instant.",
                            use: "Utiliser",
                            added: "Ajouté",
                            remove_saved: "Supprimer le document enregistré",
                            parsed_at: "Analysé",
            ...
            UK: {
                translation: {
                    ...
                    components: {
                        ...
                        contextmanagerdialog: {
                            title: "Менеджер контексту",
                            description: "Виберіть файли, які будуть використані у вашому наступному питанні.",
                            uploading: "Завантаження...",
                            upload_section_title: "Завантажити документи",
                            upload_description: "Завантажуйте нові документи або повторно використовуйте вже опрацьовані документи з локального сховища.",
                            select_label: "Вибрати файли",
                            select_hint: "Можна вибрати кілька файлів.",
                            close: "Закрити",
                            saved_label: "Вже завантажені документи",
                            saved_count: "Кількість: ",
                            no_saved: "Ще немає збережених документів.",
                            use: "Використати",
                            added: "Додано",
                            remove_saved: "Видалити збережений документ",
                            parsed_at: "Опрацьовано",
