        ...
        <div className={styles.container}>
            {isEmptySystemPrompt ? (
                <Tooltip content={t("components.chattsettingsdrawer.settings_button")} relationship="description" positioning="below">
                    <Button
                        aria-label={t("components.chattsettingsdrawer.settings_button")}
                        icon={<ChatSettings24Regular />}
                ...
                <Tooltip content={t("components.chattsettingsdrawer.settings_button_system_prompt")} relationship="description" positioning="below">
                    <Button
                        aria-label={t("components.chattsettingsdrawer.settings_button_system_prompt")}
                        icon={<ChatWarning24Regular className={styles.system_prompt_warining_icon} />}
                        appearance="secondary"
                        onClick={onClick}
                        size="large"
                    ></Button>
