            ...
            <div className={styles.faqRoot}>
                ...
                <Accordion multiple collapsible navigation="linear">
                    ...
                    <AccordionItem value="2">
                        ...
                        <AccordionPanel>
                            <div className={styles.panel}>
                                MUCGPT basiert auf ChatGPT, ein Dienst von OpenAI und Microsoft. Der Unterschied zu ChatGPT liegt jedoch darin, dass Ihre eingegebenen Daten verschlüsselt an einen europäischen Server von Microsoft Azure nach Amsterdam geschickt werden und nicht in die USA abfließen.
                            </div>
                        </AccordionPanel>
                    </AccordionItem>
                    ...
                    <AccordionItem value="4">
                        ...
                        <AccordionPanel>
                            <div className={styles.panel}>
                                MUCGPT darf von allen städtischen Mitarbeitern*innen inkl. externer Dienstleister*innen (alle die einen muenchen.de-Account besitzen) im dienstlichen Kontext genutzt werden.
                            </div>
                        </AccordionPanel>
                    </AccordionItem >
