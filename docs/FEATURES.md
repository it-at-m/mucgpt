...
The resulting mindmaps can be downloaded and further processed with the tool [Freeplane](https://docs.freeplane.org/).
## General Features
Generated texts in various formats are rendered correctly. The following formats are currently supported:
- Markdown
- HTML
