            ...
            DE: {
                translation: {
                    ...
                    chat: {
                        ...
                        usage_help_context_critical_detail: "Ältere Teile des Chatverlaufs fallen bald weg - überlege, einen neuen Chat zu starten.",
                        usage_full_warning_lead: "Der Kontext ist voll.",
                        usage_full_warning_detail: "Starte am besten einen neuen Chat, damit MUCGPT den Verlauf wieder vollständig berücksichtigen kann.",
                        follow_up_actions: {
                            shorter: "Kürzer",
                            longer: "Länger",
                            formal: "Förmlicher",
            ...
            EN: {
                translation: {
                    ...
                    chat: {
                        ...
                        usage_help_context:
                            'The context window holds the most recent messages. Once it\'s full, MUCGPT "forgets" older parts of the conversation.',
                        usage_help_context_warning_lead: "The context is getting tight.",
                        usage_help_context_warning_detail: "Once it's full, older parts of the conversation drop off to make room for new messages.",
                        usage_help_context_critical_lead: "The context is nearly full.",
                        usage_help_context_critical_detail: "Older parts of the conversation will drop off soon - consider starting a new chat.",
                        usage_full_warning_lead: "The context is full.",
                        usage_full_warning_detail: "Start a new chat so MUCGPT can take the full conversation into account again.",
                        follow_up_actions: {
                            shorter: "Less detail",
                            longer: "More detail",
                            formal: "More formal",
            ...
            BA: {
                translation: {
                    ...
                    chat: {
                        ...
                        usage_context_summary_no_max: "Auslastung: {{used}} Tokens",
                        usage_cost: "Kosten (geschätzt): {{cost}}",
                        usage_help_context: "Im Kontextspeicher steckn de letzten Nachrichten. Wenn er vui is, „vergisst“ MUCGPT ältere Teile vom Chatverlauf.",
                        usage_help_context_warning_lead: "Da Kontext wird knapp.",
                        usage_help_context_warning_detail: "Wenn er vui is, falln ältere Teile vom Chatverlauf weg, damit neue Nachrichten Platz ham.",
                        usage_help_context_critical_lead: "Da Kontext is fast vui.",
                        usage_help_context_critical_detail: "Ältere Teile vom Chatverlauf falln bald weg - überleg dir, an neuen Chat zu starten.",
                        usage_full_warning_lead: "Da Kontext is vui.",
                        usage_full_warning_detail: "Am beschtn an neuen Chat starten, dann ko MUCGPT den ganzen Verlauf wieder berücksichtigen.",
                        follow_up_actions: {
                            shorter: "Kürzer",
                            longer: "Länger",
                            formal: "Förmlicher",
            ...
            FR: {
                translation: {
                    ...
                    home: {
                        ...
                        discover_all: "Découvrir tous les assistants",
                    ...
                    chat: {
                        ...
                        usage_help_context:
                            "La fenêtre de contexte contient les derniers messages. Une fois pleine, MUCGPT « oublie » les parties les plus anciennes de la conversation.",
                        usage_help_context_warning_lead: "Le contexte commence à se remplir.",
                        usage_help_context_warning_detail:
                            "Une fois plein, les parties les plus anciennes de la conversation seront supprimées pour faire de la place.",
                        usage_help_context_critical_lead: "Le contexte est presque plein.",
                        usage_help_context_critical_detail:
                            "Les parties les plus anciennes vont bientôt être supprimées - pensez à démarrer une nouvelle conversation.",
                        usage_full_warning_lead: "Le contexte est plein.",
                        usage_full_warning_detail: "Démarrez plutôt une nouvelle conversation pour que MUCGPT prenne à nouveau en compte tout l’historique.",
                        follow_up_actions: {
                            shorter: "Plus court",
                            longer: "Plus long",
                            formal: "Plus formel",
            ...
            UK: {
                translation: {
                    ...
                    chat: {
                        ...
                        usage_help_context: "Контекстне вікно містить останні повідомлення. Коли воно заповнюється, MUCGPT «забуває» старіші частини розмови.",
                        usage_help_context_warning_lead: "Контекст заповнюється.",
                        usage_help_context_warning_detail: "Коли він заповниться, старіші частини розмови зникнуть, щоб звільнити місце для нових повідомлень.",
                        usage_help_context_critical_lead: "Контекст майже повний.",
                        usage_help_context_critical_detail: "Старіші частини розмови скоро зникнуть - варто почати новий чат.",
                        usage_full_warning_lead: "Контекст заповнений.",
                        usage_full_warning_detail: "Найкраще почати новий чат, щоб MUCGPT знову міг враховувати всю історію розмови.",
                        follow_up_actions: {
                            shorter: "Коротше",
                            longer: "Довше",
                            formal: "Офіційніше",
